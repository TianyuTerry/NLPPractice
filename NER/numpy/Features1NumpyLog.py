...
def forward_backward_test(x, tag2index, emission_weight, transition_weight):
    ...
    _, log_Z1 = forward(x, tag2index, emission_weight, transition_weight)
    _, log_Z2 = backward(x, tag2index, emission_weight, transition_weight)
    print(log_Z1, log_Z2)
...
def GradientTransition(X, Y, tag2index, word2index, emission_weight, transition_weight, param):
...
def testTransition(epsilon, X, Y, tag1, tag2, tag2index, word2index, emission_weight, transition_weight, param):
...
def testEmission(epsilon, X, Y, tag, word, tag2index, word2index, emission_weight, transition_weight, param):
...
def testTransitionAll(epsilon, X, Y, tag2index, word2index, emission_weight, transition_weight, param):
    T = len(tag2index)
...
def testEmissionAll(epsilon, X, Y, tag2index, word2index, emission_weight, transition_weight, param):
    T, V = len(tag2index), len(word2index)
...
def main():
    ...
    # train_X, train_X_str, train_Y, train_Y_str = train_X[:8], train_X_str[:8], train_Y[:8], train_Y_str[:8]
    np.random.seed(1)
    T, V = len(tag2index), len(word2index)
    ...
    forward_backward_test(train_X[-1], tag2index, emission_weight, transition_weight)
    ...
    # testEmissionAll(epsilon, train_X[1:2], train_Y[1:2], tag2index, word2index, emission_weight, transition_weight, param=0.1)
